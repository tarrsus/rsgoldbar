...
/* harmony import */ var _base_page_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../base-page.component */ "W1PF");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! rxjs/operators */ "kU1M");
/* harmony import */ var src_app_shared_base_page_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/shared/base-page.service */ "1OqD");
/* harmony import */ var src_app_shared_requests_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/shared/requests.service */ "gzKn");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/router */ "tyNb");
/* harmony import */ var src_app_shared_watcher_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/shared/watcher.service */ "Qn77");
/* harmony import */ var src_app_shared_user_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/shared/user.service */ "CcaC");
...
class LoginComponent extends _base_page_component__WEBPACK_IMPORTED_MODULE_4__["BasePageComponent"] {
    // tslint:disable-next-line:max-line-length
    constructor(basePageService, req, route, router, watcher, user) {
        super();
    ...
    ngOnInit() {
        ...
        this.route.queryParams.subscribe(result => {
            if (!Object(src_app_shared_utils__WEBPACK_IMPORTED_MODULE_2__["isEmptyOrNull"])(result.identifier) && !Object(src_app_shared_utils__WEBPACK_IMPORTED_MODULE_2__["isEmptyOrNull"])(result.userId)) {
                ...
                }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.componentDestroyed$)).subscribe(response => {
                    this.watcher.logout();
                });
            }
        });
    ...
    login(data) {
        const loginUrl = `${src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl}/api/oauth`;
        this.req.post(loginUrl, data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.componentDestroyed$)).subscribe(result => {
...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵInheritDefinitionFeature"]], decls: 35, vars: 10, consts: [[1, "selling-page"], [1, "main-container"], [1, "container-fluid"], [1, "container-fluid", "material-ui"], [1, "row"], [1, "col-12"], [1, "common-form", 3, "formGroup", "ngSubmit"], [1, "form-title", "text-center"], ["appearance", "outline"], ["matInput", "", "placeholder", "Email", "formControlName", "email", "type", "text", 3, "errorStateMatcher"], [4, "ngIf"], ["matInput", "", "placeholder", "Password", "formControlName", "password", "type", "password", 3, "errorStateMatcher"], ["mat-raised-button", "", "type", "submit", 3, "disabled"], [1, "pt-2"], [3, "routerLink"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function LoginComponent_Template_form_ngSubmit_6_listener() { return ctx.login(ctx.loginForm.value); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](LoginComponent, [{
    ...
    }], function () { return [{ type: src_app_shared_base_page_service__WEBPACK_IMPORTED_MODULE_6__["BasePageService"] }, { type: src_app_shared_requests_service__WEBPACK_IMPORTED_MODULE_7__["RequestsService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_8__["ActivatedRoute"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_8__["Router"] }, { type: src_app_shared_watcher_service__WEBPACK_IMPORTED_MODULE_9__["WatcherService"] }, { type: src_app_shared_user_service__WEBPACK_IMPORTED_MODULE_10__["UserService"] }]; }, null); })();
...
/* harmony import */ var _login_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./login-routing.module */ "ylMM");
/* harmony import */ var _login_login_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./login/login.component */ "+Oy8");
...
/* harmony import */ var _login_login_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./login/login.component */ "+Oy8");
...
//# sourceMappingURL=core-login-login-module-es2015.js.map