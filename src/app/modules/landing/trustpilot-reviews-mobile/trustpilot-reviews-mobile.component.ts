...
@Component({
  selector: 'app-trustpilot-reviews-mobile',
  templateUrl: './trustpilot-reviews-mobile.component.html',
  styleUrls: ['./trustpilot-reviews-mobile.component.sass']
})
export class TrustpilotReviewsMobileComponent implements OnInit {
  reviews = [
    {
      firstName: 'Tyler',
      lastName: 'Watkins',
